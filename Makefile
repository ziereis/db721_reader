...
#### Main build
# For regular CLI build, we link the db721 extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/db721/db721.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/db721/db721.duckdb_extension'
